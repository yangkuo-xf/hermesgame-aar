...
public class WebViewLoadingDialog extends Dialog {
    ...
    public WebViewLoadingDialog(@NonNull Context context) {

        super(context, QGSdkUtils.getResId(context, "R.style.qg_dialog_style_fullscreen"));
        setContentView(QGSdkUtils.getResId(context, "R.layout.qg_webview_loading_dialog"));
        img=(ImageView)findViewById(QGSdkUtils.getResId(context,"R.id.qg_webview_loading_dialog_img"));
        img.setBackgroundResource(QGSdkUtils.getResId(context, "R.drawable.qg_webview_loading_dialog_anim"));
